...
//失败的订单
public class Dingdan5 extends Activity{
	public static final String TAG = "Dingdan5";
	...
	String title;
		...
		public void init() {
			...
			dingdan5 = (ListView) this.findViewById(R.id.dingdan5);
		...
		class Exit implements OnClickListener {
			...
			public void onClick(View v) {
				...
				intent.setClass(Dingdan5.this, MainActivity.class);								
			...
			new Thread() {
				...
				public void run() {
					...
					try {
						...
						if(total_results==0){
							Intent intent = new Intent();
							intent.setClass(Dingdan5.this, Error.class);								
		...
		Handler handler = new Handler() {
			public void handleMessage(Message message) {
				if (ois != null) { 
					dingdan5.setOnItemClickListener(new OnItemClickListener() {
						@Override
						public void onItemClick(AdapterView<?> arg0, View view,int arg2, long arg3) {
							...
							if (obj != null) {
								...
								Util.tid=tid;
								intent.setClass(Dingdan5.this, Dingdanxiangqing.class);								
							    startActivity(intent);
							}
						}

					});
					OnSaleAdapter adapter = new OnSaleAdapter(Dingdan5.this);
					dingdan5.setAdapter(adapter);
		...
		public String onFaGet() {
			...
			apiparamsMap.put("status", "TRADE_CLOSED");
