...
//正在发货
public class Fahuo1 extends Activity{
	public static final String TAG = "Fahuo1";
	...
	String title;
		...
		class Exit implements OnClickListener {
			...
			public void onClick(View v) {
				...
				intent.setClass(Fahuo1.this, MainActivity.class);								
			...
			new Thread() {
				...
				public void run() {
					...
					try {
						...
						if(total_results==0){
							Intent intent = new Intent();
							intent.setClass(Fahuo1.this, Error.class);	
							finish();
						    startActivity(intent);
						}
					...
					onFahuoList.setOnItemClickListener(new OnItemClickListener() {
						...
						public void onItemClick(AdapterView<?> arg0, View view,int arg2, long arg3) {
							...
							if (obj != null) {
								...
								Util.tid=tid;
								intent.setClass(Fahuo1.this, WuliuActivity.class);								
							    startActivity(intent);
							}
						}

					});
					OnSaleAdapter adapter = new OnSaleAdapter(Fahuo1.this);
