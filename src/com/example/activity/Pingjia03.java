...
import com.example.entity.PingJiaCha;
...
public class Pingjia03 extends Activity {
	public static final String TAG = "Pingjia02";
	List<PingJiaCha>pijia;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ping03);
    ...
    public void init() {
		loadingLayout = (LinearLayout) findViewById(R.id.loadingLayoutcha);
		pingjiaList = (ListView) this.findViewById(R.id.pingjiaListcha);
		TextView tv= (TextView)findViewById(R.id.empty03); 
    ...
    class Exit implements OnClickListener {
		...
		public void onClick(View v) {
			...
			intent.setClass(Pingjia03.this, MainActivity.class);								
    ...
    /**
   		...
   		new Thread() {
   			...
   			public void run() {
   				...
   				try {
					...
					if(total_results==0){
						Intent intent = new Intent();
						intent.setClass(Pingjia03.this, Error.class);	
						finish();
					    startActivity(intent);
					}
   					...
   					for (int i = 0; i < data.length(); i++) {
   						...
   						if (pijia == null) {
   							pijia = new ArrayList<PingJiaCha>();
   						}
   						
   						PingJiaCha oi = new PingJiaCha();
   						oi.setNick(nick);
   	...
   	public class OnSaleAdapter extends BaseAdapter {
   		...
   		public View getView(int position, View convertView, ViewGroup parent) {
   			...
   			PingJiaCha wb = pijia.get(position);
   			if (wb != null) {
   				...
   				Toast.makeText(Pingjia03.this, "没有任何记录哦",
   	...
   	public String onPingjiaGet() {
   		...
   		apiparamsMap00.put("result","bad");
   		apiparamsMap00
   				.put("fields",
   						"tid,oid,role,nick,created,rated_nick,item_title,item_price,content,reply,num_iid");// 需要获取的字段
