...
public class ShangPinKuCun extends Activity {
	public static final String TAG = "ShangPinKuCun";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shangpinkucun);
    ...
    public void initWidgt(){ 
    	...
    	tupian = (ImageView) this.findViewById(R.id.tupianku);  	
    	mingcheng = (TextView) this.findViewById(R.id.mingchengku);
    	jiage = (TextView) this.findViewById(R.id.jiageku);
    	shuliang = (TextView) this.findViewById(R.id.shuliangku);
    	qixian= (TextView) this.findViewById(R.id.qixianku);
    	ping= (TextView) this.findViewById(R.id.pingku);
    	kuai= (TextView) this.findViewById(R.id.kuaiku);
    	ems= (TextView) this.findViewById(R.id.emsku);
    	bianma= (TextView) this.findViewById(R.id.bianmaku);
    ...
    class Exit implements OnClickListener {
		...
		public void onClick(View v) {
			...
			intent.setClass(ShangPinKuCun.this, MainActivity.class);								
