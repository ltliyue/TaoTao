...
public class ChaKanWuLiu extends Activity{
	public static final String TAG = "ChaKanWuLiu";
	...
	String title;
		...
		public void init() {
			...
			loadingLayout=(LinearLayout) this.findViewById(R.id.loadingLayout01);
		...
		class Exit implements OnClickListener {
			...
			public void onClick(View v) {
				...
				intent.setClass(ChaKanWuLiu.this, MainActivity.class);								
			...
			new Thread() {
				...
				public void run() {
					...
					try {
						...
						if(total_results==0){
							Intent intent = new Intent();
							intent.setClass(ChaKanWuLiu.this, Nofahuo.class);	
						...
						for (int i = 0; i < data2.length(); i++) {
							if(total_results==0){
								Intent intent = new Intent();
								intent.setClass(ChaKanWuLiu.this, Error.class);								
							    startActivity(intent);
							}
					...
					onFahuoList.setOnItemClickListener(new OnItemClickListener() {
						...
						public void onItemClick(AdapterView<?> arg0, View view,int arg2, long arg3) {
							...
							if (obj != null) {
								...
								Util.tid=tid;
								intent.setClass(ChaKanWuLiu.this, WuliuActivity.class);								
							    startActivity(intent);
							}
						}

					});
					OnSaleAdapter adapter = new OnSaleAdapter(ChaKanWuLiu.this);
