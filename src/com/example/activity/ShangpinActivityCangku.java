...
public class ShangpinActivityCangku extends Activity {
	public static final String TAG = "ShangpinActivityCangku";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shangpincangku);
        ...
        button01.setOnClickListener(new OnClickListener(){
           	...
           	public void onClick(View v) {
           		intent.setClass(ShangpinActivityCangku.this, ShangJiaActivity.class);
       		    finish();
        ...
        button02.setOnClickListener(new OnClickListener(){
           	Intent intent = new Intent();
           	public void onClick(View v) {
           		intent.setClass(ShangpinActivityCangku.this, XiuGaiXinXiActivity.class);
           		finish();
           		startActivity(intent);
           	}
    ...
    public void initWidgt(){ 
    	button01=(Button)this.findViewById(R.id.shangjiacang);
    	button02=(Button)this.findViewById(R.id.xiugaicang);
       	tupian = (ImageView) this.findViewById(R.id.tupiancang);  	
    	mingcheng = (TextView) this.findViewById(R.id.mingchengcang);
    	jiage = (TextView) this.findViewById(R.id.jiagecang);
    	shuliang = (TextView) this.findViewById(R.id.shuliangcang);
    	qixian= (TextView) this.findViewById(R.id.qixiancang);
    	ping= (TextView) this.findViewById(R.id.pingcang);
    	kuai= (TextView) this.findViewById(R.id.kuaicang);
    	ems= (TextView) this.findViewById(R.id.emscang);
    	bianma= (TextView) this.findViewById(R.id.bianmacang);
	...
	class Exit implements OnClickListener {
		...
		public void onClick(View v) {
			Intent intent = new Intent();
			intent.setClass(ShangpinActivityCangku.this, MainActivity.class);								
		    startActivity(intent);
		    }
	}
	...
	class Fanhui implements OnClickListener {
 		...
 		public void onClick(View v) {  
 			...
 			ShangpinActivityCangku.this.finish();
 		}
 	}
