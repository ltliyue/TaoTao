...
//等待卖家发货
public class Dingdan2 extends Activity{
	public static final String TAG = "Dingdan2";
	...
	LinearLayout loadingLayout,exit,fanhui;
	 AlertDialog alertDialog;
		...
		public void init() {
			...
			dingdan2 = (ListView) this.findViewById(R.id.dingdan2);
		...
		class Exit implements OnClickListener {
			...
			public void onClick(View v) {
				...
				intent.setClass(Dingdan2.this, MainActivity.class);								
			...
			new Thread() {
				...
				public void run() {
					...
					try {
						...
						if(total_results==0){
							Intent intent = new Intent();
							intent.setClass(Dingdan2.this, Error.class);								
		...
		Handler handler = new Handler() {
			public void handleMessage(Message message) {
				if (ois != null) { 
					dingdan2.setOnItemClickListener(new OnItemClickListener() {
						@Override
						public void onItemClick(AdapterView<?> arg0, View view,int arg2, long arg3) {
							...
							if (obj != null) {
								...
								Util.tid=tid;
								intent.setClass(Dingdan2.this, Shangpin_fahuo.class);								
							    startActivity(intent);
							}
						}

					});
					OnSaleAdapter adapter = new OnSaleAdapter(Dingdan2.this);
					dingdan2.setAdapter(adapter);
		...
		public String onFaGet() {
			...
			apiparamsMap.put("status", "WAIT_SELLER_SEND_GOODS");
