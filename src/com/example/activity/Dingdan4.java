...
//成功的订单
public class Dingdan4 extends Activity{
	public static final String TAG = "Dingdan4";
	...
	String title;
		...
		public void init() {
			...
			dingdan4 = (ListView) this.findViewById(R.id.dingdan4);
		...
		class Exit implements OnClickListener {
			...
			public void onClick(View v) {
				...
				intent.setClass(Dingdan4.this, MainActivity.class);								
			...
			new Thread() {
				...
				public void run() {
					...
					try {
						...
						if(total_results==0){
							Intent intent = new Intent();
							intent.setClass(Dingdan4.this, Error.class);								
		...
		Handler handler = new Handler() {
			public void handleMessage(Message message) {
				if (ois != null) { 
					dingdan4.setOnItemClickListener(new OnItemClickListener() {
						@Override
						public void onItemClick(AdapterView<?> arg0, View view,int arg2, long arg3) {
							...
							if (obj != null) {
								...
								Util.tid=tid;
								intent.setClass(Dingdan4.this, Dingdanxiangqing.class);								
							    startActivity(intent);
							}
						}

					});
					OnSaleAdapter adapter = new OnSaleAdapter(Dingdan4.this);
					dingdan4.setAdapter(adapter);
		...
		public String onFaGet() {
			...
			apiparamsMap.put("status", "TRADE_FINISHED");
