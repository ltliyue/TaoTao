...
public class Dingdanxiangqing extends Activity {
	public static final String TAG = "Dingdanxiangqing";
    ...
    public void initWidgt(){ 
    	...
    	tupian = (ImageView) this.findViewById(R.id.ding_tupian);  	
    	mingcheng = (TextView) this.findViewById(R.id.ding_mingcheng);
    	jiaoyi = (TextView) this.findViewById(R.id.ding_jiaoyi);
    	maijia = (TextView) this.findViewById(R.id.ding_maijia);
    	shijian= (TextView) this.findViewById(R.id.ding_shijian);
    	danjia= (TextView) this.findViewById(R.id.ding_danjia);
    	yunfei= (TextView) this.findViewById(R.id.ding_yunfei);
    	shuliang= (TextView) this.findViewById(R.id.ding_shuliang);
    	zongji= (TextView) this.findViewById(R.id.ding_zongji);
    	dizhi= (TextView) this.findViewById(R.id.ding_dizhi);
    ...
    class Exit implements OnClickListener {
		...
		public void onClick(View v) {
			...
			intent.setClass(Dingdanxiangqing.this, MainActivity.class);								
