...
//等待买家确认收货
public class Dingdan3 extends Activity{
	public static final String TAG = "Dingdan3";
	...
	String title;
		...
		public void init() {
			...
			dingdan3 = (ListView) this.findViewById(R.id.dingdan3);
		...
		class Exit implements OnClickListener {
			...
			public void onClick(View v) {
				...
				intent.setClass(Dingdan3.this, MainActivity.class);								
			...
			new Thread() {
				...
				public void run() {
					...
					try {
						...
						if(total_results==0){
							Intent intent = new Intent();
							intent.setClass(Dingdan3.this, Error.class);								
		...
		Handler handler = new Handler() {
			public void handleMessage(Message message) {
				if (ois != null) { 
					dingdan3.setOnItemClickListener(new OnItemClickListener() {
						@Override
						public void onItemClick(AdapterView<?> arg0, View view,int arg2, long arg3) {
							...
							if (obj != null) {
								...
								Util.tid=tid;
								intent.setClass(Dingdan3.this, Dingdanxiangqing.class);								
							    startActivity(intent);
							}
						}

					});
					OnSaleAdapter adapter = new OnSaleAdapter(Dingdan3.this);
					dingdan3.setAdapter(adapter);
		...
		public String onFaGet() {
			...
			apiparamsMap.put("status", "WAIT_BUYER_CONFIRM_GOODS");
