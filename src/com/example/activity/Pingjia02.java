...
import com.example.entity.PingJiaZhong;
...
public class Pingjia02 extends Activity {
	public static final String TAG = "Pingjia02";
	List<PingJiaZhong>pijia;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ping02);
    ...
    public void init() {
		loadingLayout = (LinearLayout) findViewById(R.id.loadingLayoutzhong);
		pingjiaList = (ListView) this.findViewById(R.id.pingjiaListzhong);
    ...
    class Exit implements OnClickListener {
		...
		public void onClick(View v) {
			...
			intent.setClass(Pingjia02.this, MainActivity.class);								
    ...
    /**
   		...
   		new Thread() {
   			...
   			public void run() {
   				...
   				try {
					...
					if(total_results==0){
						Intent intent = new Intent();
						intent.setClass(Pingjia02.this, Error.class);	
						finish();
					    startActivity(intent);
					}
   					...
   					for (int i = 0; i < data.length(); i++) {
   						...
   						if (pijia == null) {
   							pijia = new ArrayList<PingJiaZhong>();
   						}
   						
   						PingJiaZhong oi = new PingJiaZhong();
   						oi.setNick(nick);
   	...
   	public class OnSaleAdapter extends BaseAdapter {
   		...
   		public View getView(int position, View convertView, ViewGroup parent) {
   			...
   			PingJiaZhong wb = pijia.get(position);
   			if (wb != null) {
   				...
   				Toast.makeText(Pingjia02.this, "没有任何记录哦",
   	...
   	public String onPingjiaGet() {
   		...
   		apiparamsMap00.put("result","neutral");
   		apiparamsMap00
   				.put("fields",
